...
while True:
    ...
    get_all_value(layer.press_cell[len(layer.press_interface) - 2], press_bottom_sn, 'press')
    get_all_value(layer.press_cell[1], press_bottom_tr, 'press')
    # get_all_value(layer.x_interface[98], coord_arr, 'press')
    coord_arr.append(layer.x_interface[98])
...
# get_plot(coord_arr, all_speed_arr, 'Время', 'Скорость', 'График зависимости скорости снаряда от координаты зап.пр.')

plt.plot(all_time_arr, all_speed_arr)
plt.grid(True)
plt.ylabel('Vp, м/с')
plt.xlabel('t, c')
plt.show()

plt.plot(coord_arr, all_speed_arr)
plt.grid(True)
plt.ylabel('Vp, м/с')
plt.xlabel('L, м')
plt.show()

plt.plot(all_time_arr, press_bottom_sn, '--')
plt.plot(all_time_arr, press_bottom_tr)
plt.grid(True)
plt.ylabel('P, Па')
plt.xlabel('t, c')
plt.show()

plt.plot(coord_arr, press_bottom_sn, '--')
plt.plot(coord_arr, press_bottom_tr)
plt.grid(True)
plt.ylabel('P, Па')
plt.xlabel('L, м')
plt.show()
